...
export const projects = [
        ...
        data: [
            {
                ...
                data: [
                    {
                        title: "Sort Music",
                        description: "This repository implements a script to detect an audio file using <a href='https://rapidapi.com/apidojo/api/shazam/' target='_blank'>Shazam API</a> to identify songs. After detecting the song and its properties - like artist, song name, album, year, etc. - it can change the properties of given file respectively and saves it as MP3 file. To use the provided python script, you first have to create your own account at <a href='https://rapidapi.com/' target='_blank'>rapidAPI</a>. Using the free trial only - which costs 0€ - you can send up to 500 requests per months. So this project may not be suitable to reorganize your whole music bibliography of multiple of thousands songs. Even though it could.",
                        link_live: "",
            ...
            },
            {
                ...
                data: [
                    {
                        title: "MNIST",
                        description: "This repositoriy is built to play around with some well-known datasets - such as <a href='http://yann.lecun.com/exdb/mnist/' target='_blank'>MNIST dataset</a> or <a href='https://www.unb.ca/cic/datasets/nsl.html' target='_blank'>UNB's NSL-KDD dataset</a> - to demonstrate a typical Machine Learning Pipeline, the power of Feature Reduction, using Neural Networks with <a href='https://towardsdatascience.com/image-similarity-using-triplet-loss-3744c0f67973' target='_blank'>Triplet Loss</a>. Name of the repository was chosen after using MNIST as first dataset to check the networks performance. The proposed Pipeline consists of all typical steps during a Machine Learning process, such as NaN handling, conversion of categorical data into numerical, scaling and feature reduction (to increase training/prediction process). In the end, the results are evaluated visually and statistically",
                        link_live: "",
    ...
    {
        year: "2020",
        description: "After moving to a new city and due to corona pandemic causing a first lockdown in Germany, I spent much time on improving my full-stack development skills. Special focus hereby was on Webdevelopment because I had never done much on this before. Using <a href='https://www.udemy.com/' target='_blank'>Udemy</a> and the help of <a href='https://github.com/aneagoie' target='_blank'>Andrei Neagoie</a> I was able to implement several different web applications. Furthermore I successfully took part in two hackathons and implemented an own little version of <a href='https://scikit-learn.org/stable/' target='_blank'>sklearn</a> being inspired by one of my masters courses.",
        data: [
            {
                name: "",
                description: "",
